          ...
          <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
            <div className="flex items-start justify-between mb-2 sm:mb-3">
              <div className="flex-1">
                <h3 className="text-white font-bold text-base sm:text-lg mb-1 sm:mb-2 font-syne line-clamp-1">
                  {image.title}
                </h3>
            ...
            <button className="w-full px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg bg-linear-to-r from-violet-600 to-cyan-500 text-white text-xs sm:text-sm font-semibold hover:shadow-lg hover:shadow-violet-500/50 transition-all duration-300">
              View Details →
            </button>
          </div>
        </div>

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="text-xl font-bold font-[family-name:var(--font-syne)]">
              ...
              {isLoggedIn ? (
                <>
                  <Link href="/profile" className="flex items-center gap-3 group">
                    ...
                    <div className="w-9 h-9 rounded-full bg-gradient-to-br from-violet-600 to-cyan-500 p-0.5">
                      <div className="w-full h-full rounded-full bg-[#080b10] flex items-center justify-center text-white font-semibold">
                        JD
                      </div>
                    </div>
                  </Link>
                  <GhostButton variant="danger" className="text-sm px-4 py-2">
                    Logout
                  </GhostButton>
                </>
              ) : (
                <>
                  <Link href="/signin">
                    <GhostButton className="text-sm px-4 py-2">
                      Sign In
                    </GhostButton>
                  </Link>
                  <Link href="/signup">

      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
        ...
        <div className="bg-[#0f1318] border border-white/10 rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8">
          <div className="flex flex-col items-center text-center">
            {/* Avatar skeleton */}
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-violet-600/20 to-cyan-500/20 mb-4 sm:mb-6 skeleton" />
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-8 sm:mb-12">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-[#0f1318] border border-white/10 rounded-xl p-4 sm:p-6 text-center">

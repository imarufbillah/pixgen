          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-[#0f1318] rounded-lg border border-white/5"
                >
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="h-7 bg-white/10 rounded-full w-20 skeleton"
                  />
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-2 sm:mt-4">
              ...
              <div className="flex-1 h-12 bg-linear-to-r from-violet-600/20 to-cyan-500/20 rounded-full skeleton" />
            </div>
          </div>
        </div>
      </div>

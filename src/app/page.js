        ...
        >
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-4 sm:mb-6 font-syne">
              <span className="text-white mb-2 block animate-slide-in-left">
                Create. Imagine.
              </span>
            ...
            <p
              className="text-base sm:text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4 animate-fade-in"
              style={{
                animationDelay: "0.2s",
                opacity: 0,
            ...
            <div
              className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4 animate-fade-in"
              style={{
                animationDelay: "0.4s",
                opacity: 0,
                animationFillMode: "forwards",

...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Success toast
      toast.success("Account created successfully! Welcome to PixGen.", "Sign Up Successful");
      
      // Redirect or handle success (e.g., router.push('/signin'))
      
    } catch (error) {
      console.error("Sign up error:", error);
      toast.error("Failed to create account. Please try again.", "Sign Up Failed");

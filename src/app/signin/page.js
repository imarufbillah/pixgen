  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden grain-texture">
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="bg-[#0f1318] border border-white/10 rounded-2xl p-8 shadow-2xl shadow-violet-500/10">
          {/* Logo */}
          <div className="flex items-center justify-center gap-2 mb-8">
            <Sparkles className="text-violet-400" size={32} />
            <span className="text-3xl font-bold font-[family-name:var(--font-syne)]">
          ...
          <form className="flex flex-col gap-5">
            ...
            <GradientButton className="w-full py-4 mt-2">
              Sign In
            </GradientButton>
          </form>
          ...
          {/* Google OAuth Button */}
          <button className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white rounded-lg hover:bg-slate-100 transition-colors">
